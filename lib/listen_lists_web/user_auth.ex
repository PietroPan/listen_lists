defmodule ListenListsWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ListenListsWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule ListenListsWeb.PageLive do
        use ListenListsWeb, :live_view

        on_mount {ListenListsWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ListenListsWeb.UserAuth, :ensure_authenticated}] do
