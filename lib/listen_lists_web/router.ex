defmodule ListenListsWeb.Router do
  use ListenListsWeb, :router

  import ListenListsWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ListenListsWeb.Layouts, :root}
  ...
  # scope "/api", ListenListsWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:listen_lists, :dev_routes) do
  ...
  scope "/", ListenListsWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ListenListsWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ListenListsWeb do
    ...
    live_session :current_user,
      on_mount: [{ListenListsWeb.UserAuth, :mount_current_user}] do
